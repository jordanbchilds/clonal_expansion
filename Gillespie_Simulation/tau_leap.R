...
qntl_plotter = function(x, ylim, t, title, main){
...
par(mfrow=c(1,2))
  qntl_plotter(tauLeap_qntl[[1]], ylim=c(0,600), title="Copy Number", main="dt = 1 day" )
  qntl_plotter(tauLeap_qntl[[2]], ylim=c(0,1), title="Mutation Load", main="dt = 1 day" )
  qntl_plotter(tauLeap_qntl_2dt[[1]], ylim=c(0,600), title="Copy Number", main="dt = 2 days" )
  qntl_plotter(tauLeap_qntl_2dt[[2]], ylim=c(0,1), title="Mutation Load", main="dt = 2 days" )
  qntl_plotter(tauLeap_qntl_3dt[[1]], ylim=c(0,600), title="Copy Number", main="dt = 3 days" )
  qntl_plotter(tauLeap_qntl_3dt[[2]], ylim=c(0,1), title="Mutation Load", main="dt = 3 days" )
  qntl_plotter(tauLeap_qntl_4dt[[1]], ylim=c(0,600), title="Copy Number", main="dt = 4 days" )
  qntl_plotter(tauLeap_qntl_4dt[[2]], ylim=c(0,1), title="Mutation Load", main="dt = 4 days" )
  qntl_plotter(tauLeap_qntl_5dt[[1]], ylim=c(0,600), title="Copy Number", main="dt = 5 days" )
  qntl_plotter(tauLeap_qntl_5dt[[2]], ylim=c(0,1), title="Mutation Load", main="dt = 5 days" )
dev.off()
